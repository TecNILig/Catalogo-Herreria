// layout.js - Inyección de navegación y footer en todas las vistas
// Tecnilight Catálogo de Herrería

const SITE_CONFIG = {
    nombre: 'Tecnilight',
    slogan: 'Herrería Artística & Iluminación',
    whatsapp: '522214353123',
    facebook: 'https://www.facebook.com/share/1EwCAu5eXj/',
    instagram: 'https://www.instagram.com/tecnilight.iluminacion?igsh=cWR1cWg0dnd5dmZz'
};
...
<nav class="navbar">
    <div class="container nav-container">
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li><a href="personalizados.html" class="nav-link">Personalizados</a></li>
    ...
    <div class="container">
        <div class="footer-grid" style="grid-template-columns: 1fr 1fr;">
            <div class="footer-brand">
                <h3>${SITE_CONFIG.nombre}</h3>
                <p>${SITE_CONFIG.slogan}</p>
                <div class="footer-social">
                    <a href="https://wa.me/${SITE_CONFIG.whatsapp}" target="_blank" aria-label="WhatsApp" class="social-icon whatsapp">
                    ...
                    <a href="${SITE_CONFIG.facebook}" target="_blank" aria-label="Facebook" class="social-icon facebook">
                    ...
                    <a href="${SITE_CONFIG.instagram}" target="_blank" aria-label="Instagram" class="social-icon instagram">
            ...
            <div class="footer-links">
                ...
                <ul>
                    ...
                    <li><a href="personalizados.html">Cotizar</a></li>
                    <li><a href="nosotros.html">Sobre Nosotros</a></li>
                </ul>
            </div>
        </div>
        <div class="footer-bottom">
            <p>&copy; ${new Date().getFullYear()} ${SITE_CONFIG.nombre}. Todos los derechos reservados.</p>
        </div>
    </div>
</footer>
`;
